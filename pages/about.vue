    ...
    <section class="pt-32 lg:pt-40 grid grid-cols-12 px-2 sm:px-9 lg:px-7" ref="container">
        ...
        <div class="col-span-12 lg:col-span-6 mb-24 lg:mb-36">
            <p class="text-sm max-w-lg opacity-0 mb-8" id="About_Paragraph">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aperiam
                voluptate incidunt accusamus neque dolor esse voluptatem molestiae, voluptatum dolorum ullam perspiciatis,
        ...
        <div class="col-span-12 lg:col-span-8 lg:pt-24 flex flex-wrap mb-24 lg:mb-36 font-light lg:text-lg" id="About_Skills">
        ...
        <div id="About_Experiences"
            ...
            <div class="flex flex-col gap-12">
                ...
                <Experiences title="2015 - 2016" subtitle="Junior Designer AKQA" class="w-full opacity-0 translate-y-10  About_Experiences_Each"></Experiences>
            </div>
            <div class="flex flex-col gap-12">
                <Experiences title="2021 - 2022" subtitle="Design Director Play" class="w-full opacity-0 translate-y-10  About_Experiences_Each"></Experiences>
                <Experiences title="2017 - 2018" subtitle="Digital Designer Google" class="w-full opacity-0 translate-y-10  About_Experiences_Each"></Experiences>
                <Experiences title="2011 - 2014" subtitle="Design Intern AKQA" class="w-full opacity-0 translate-y-10  About_Experiences_Each"></Experiences>
            </div>
        </div>
    </section>
